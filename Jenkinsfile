pipeline {
    ...
    stages {
        ...
        stage ('5. Email Notification') {
            steps {
               mail bcc: 'stelzy79@gmail.com', body: '''Terraform deployment is completed.
               Let me know if the changes look okay.
               Thanks,
               Dominion System Technologies,
              +1 (313) 413-1477''', cc: 'stelzy79@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'stelzy79@gmail.com'
